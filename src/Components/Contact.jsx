                    ...
                    <div className="row gy-4">
                        ...
                        <div className="col-md-4">
                            <div className="bg-light d-flex flex-column justify-content-center p-4">
                                ...
                                <p className="m-0"><i className="fa fa-envelope text-color me-2"></i><a href="mailto:vimalbhartiofficial@gmail.com" className='text-dark'>vimalbhartiofficial@gmail.com</a></p>
                            </div>
                        </div>
                        <div className="col-md-4">
                            <div className="bg-light d-flex flex-column justify-content-center p-4">
                                <h5 className="text-uppercase"> Phone :-</h5>
                                <p className="m-0"><i className="fa fa-phone text-color me-2"></i><a href="tel:+91 9608267530" className='text-dark'>+91-9608267530</a></p>
                            </div>
                        </div>
                    </div>
                </div>

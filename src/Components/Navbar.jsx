                ...
                <div className="row gx-0 d-none d-lg-flex">
                    ...
                    <div className="col-lg-8 px-5 text-end">
                        <div className="h-100 d-inline-flex align-items-center py-3 me-4">
                            ...
                            <small><Link to="tel:9608267530" className='text-dark'>+91-9608267530 </Link></small>
                        </div>
                        <div className="h-100 d-inline-flex align-items-center py-3 me-4">
                            <small className="fa fa-envelope text-dark me-2"></small>
                            <small ><Link to="mailto:vimalbhartiofficial@gmail.com" className='text-dark'>vimalbhartiofficial@gmail.com </Link></small>
                        </div>
